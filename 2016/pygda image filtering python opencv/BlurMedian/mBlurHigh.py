...
img = cv2.imread("/home/szymek/Desktop/PythonFiltering/BlurMedian/photos/HighEnergy.png")
...
FirstTurn = doItAgain(7, 1, img)
cv2.namedWindow('First Turn - kernel size 7x7', cv2.WINDOW_NORMAL)
cv2.imshow('First Turn - kernel size 7x7', FirstTurn)
print "Done!"
cv2.waitKey(0)
